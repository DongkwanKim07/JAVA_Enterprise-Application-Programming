...
@NamedQuery(name = " StudentClub.findall", query = "SELECT a FROM StudentClub a")
@Inheritance(strategy = InheritanceType.SINGLE_TABLE)
@DiscriminatorColumn(name = "academic", columnDefinition = "BIT(1)", discriminatorType = DiscriminatorType.INTEGER, length = 1)
