/********************************************************************************************************
 * File:  CmdLineOptions.java Course materials (22F) CST8277
 * 
 * @author Dongkwan Kim
 * @date 2022 09
 */
...
public class CmdLineOptions {
	...
	protected static final String GENCOUNT_USAGE = "number of random students to be generated (default: ${DEFAULT-VALUE})";
